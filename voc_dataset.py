...
class VOCDataset(Dataset):
    ...
    def __init__(self, split, size, data_dir='../data/VOCdevkit/VOC2007/', augment = True):
        super().__init__()
        self.split = split
    ...
    def get_random_augmentations(self):
        ...
        ######################################################################
        # if not self.augment:
            # If augmentation is disabled, apply only essential transformations
        return [
            transforms.Resize((self.size, self.size)),  # Explicitly set both height and width
        ...
        #         # You can add more augmentations here if desired
